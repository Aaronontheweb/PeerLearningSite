...
namespace PeerLearn.Data.Mappings
{
    public class UserMap : ClassMap<User>
    {
        public UserMap()
        {
            ...
            Map(x => x.Password).Length(DataConstants.PasswordLength*2).Not.Nullable();
            ...
            Map(x => x.FirstName).Nullable().Length(DataConstants.FirstNameLength);
            Map(x => x.LastName).Nullable().Length(DataConstants.LastNameLength);
